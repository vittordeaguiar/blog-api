...
public static class CacheKeys
{
    ...
    public static string PostById(Guid id) => $"{PostsPrefix}:id:{id}";

    public static string PostBySlug(string slug) => $"{PostsPrefix}:slug:{slug}";

    public static string AllPosts() => $"{PostsPrefix}:*";

    public static string Categories() => $"{CategoriesPrefix}:all";

    public static string CategoryById(Guid id) => $"{CategoriesPrefix}:id:{id}";

    public static string AllCategories() => $"{CategoriesPrefix}:*";
}
